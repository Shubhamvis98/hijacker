...
class WifiRow(Gtk.ListBoxRow):
    def __init__(self, ssid, bssid, manufacturer, pwr, sec, ch, other):
        ...
        second_line.pack_start(other_label, True, True, 0)
    ...
    def on_button_clicked(self, widget):
        ...
        print(f"Clicked on SSID: {self.ssid}, BSSID: {self.bssid}, Manufacturer: {self.manufacturer}, PWR: {self.pwr}, SEC: {self.sec}, CH: {self.ch}, Other: {self.other}")
...
class Airodump(Functions):
    ...
    def scan_toggle(self, widget):
        ...
        if tmp == 'stop':
            ...
            # Sample Data
            networks = [
                ("CYTA", "38:D8:2F:XX:XX:XX", "ZTE Corporation", "-78", "WPA2", "1", "B:29 | D:0"),
                ("Chris", "18:44:E6:XX:XX:XX", "ZTE Corporation", "-63", "WPA2", "3", "B:122 | D:0"),
                ("Wind WiFi", "CC:7B:35:XX:XX:XX", "Unknown Manufacturer", "-86", "WPA2", "11", "B:9 | D:0"),
